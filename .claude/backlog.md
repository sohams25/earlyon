...
- [ ] **default_log print comment**: in `earlyon/training/two_stage_trainer.py:_default_log`, add a one-line comment explaining that `print()` is intentional for a user-facing CLI default callback.
